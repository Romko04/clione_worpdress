                    ...
                    <div class="goods__content goods__content--result">
                        ...
                        <div class="goods__content-about">
                            ...
                            <div class="goods__content-about__buttons">
                                <button class="button goods__single--button  cart--button button--hover-grey" data-quantity="1" data-id="567" >Замовити<img class="popup--circle" src="<?php echo get_template_directory_uri() . "/assets/img/circle-white.svg"; ?>" alt="product"></button>
                            </div>
                        </div>
                    </div>
                </div>
